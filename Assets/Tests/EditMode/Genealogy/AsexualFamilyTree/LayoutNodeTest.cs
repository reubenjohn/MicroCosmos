...
{e.Message}");
        ...
        {
            var l0 = new LayoutNode(Root, null);

            Assert.AreEqual(
                @"{""Node"":{""Guid"":""00000000-0000-0000-0000-000000000000"",""NodeType"":0,""RegistrationTime"":""2020-01-01T00:00:00""},""Parent"":null,""Generation"":0,""XMax"":1.0,""SiblingIndex"":0,""X"":0.0,""Center"":{""x"":0.5,""y"":0.5}}",
...
00",
        ...
        {
            var l0 = new LayoutNode(Root, null);
            var l00 = new LayoutNode(new Node(Guid1, NodeType.Cell), l0);
...
00",
        ...
        public void TestLinearLayout3Generation()
        {
            var l0 = new LayoutNode(Root, null);
            var l00 = new LayoutNode(new Node(Guid1, NodeType.Cell), l0);
            var l000 = new LayoutNode(new Node(Guid2, NodeType.Cell), l00);
...
00",
        ...
        public void Test2ChildLayout()
        {
            var l0 = new LayoutNode(Root, null);
            var l00 = new LayoutNode(new Node(Guid1, NodeType.Cell), l0);
            var l01 = new LayoutNode(new Node(Guid2, NodeType.Cell), l0);
...
00  01",
        ...
        {
            var l0 = new LayoutNode(Root, null);
            var l00 = new LayoutNode(null, l0);
            var l01 = new LayoutNode(null, l0);
            var l001 = new LayoutNode(null, l00);
...
00",
            ...
            var l002 = new LayoutNode(null, l00);
            AssertDisplayHierarchy(@"
    00
  00    01
00  01",
        ...
        public void TestImpactedRightTree()
        {
            ...
            var l00 = new LayoutNode(null, l0);
            var l01 = new LayoutNode(null, l0);
            var l010 = new LayoutNode(null, l01);
            var l011 = new LayoutNode(null, l01);
...
00    01
    00  01",
            ...
            var l000 = new LayoutNode(null, l00);
            AssertDisplayHierarchy(@"
    00
00    01
00  00  01",
...
00  01  00  01",
        ...
        public void TestCascadedTreeUpdate()
        {
            ...
            var l000 = new LayoutNode(null, l00);
            var l001 = new LayoutNode(null, l00);
            var l0010 = new LayoutNode(null, l001);
...
00  01  00  01
    00",
            ...
            var l0011 = new LayoutNode(null, l001);
            AssertDisplayHierarchy(@"
        00
    00        01
00    01    00  01
    00  01",
            ...
            var l00100 = new LayoutNode(null, l0010);
            var l00101 = new LayoutNode(null, l0010);
            AssertDisplayHierarchy(@"
          00
      00          01
00      01      00  01
